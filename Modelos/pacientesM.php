...
class PacientesM extends ConexionBD
{
    ...
    static public function CrearPacienteM($tablaBD, $datosC)
    {
        ...
        $pdo = ConexionBD::cBD()->prepare("INSERT INTO $tablaBD(apellido, nombre, documento, sexo, usuario, clave, rol) 
        VALUES (:apellido, :nombre, :documento, :sexo, :usuario, :clave,:rol)");
