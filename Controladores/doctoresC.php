...
//Editar doctores
    ...
    //Borrar doctor
     ...
     #region Administración del doctor (perfil, horario, login, etc)

     #region Ingreso del Doctor al sistema
    ...
    #region Ver datos del perfil del doctor
//Ver Perfil Doctor
public function VerPerfilDoctorC(){
    ...
    #region Actualizar datos del perfil del doctor
