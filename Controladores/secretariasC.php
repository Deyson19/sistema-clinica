...
class SecretariasC{
    ...
    //Editar perfil de la secretaria
    public function EditarPerfilSecretariaC(){
        ...
        $resultado = SecretariasM::VerPerfilSecretariaM($tablaBD,$id);
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    if ($resultado["foto"] == "") {
                        echo '<img src="http://localhost/clinica/Vistas/img/defecto.png" width="200px" alt="">';
                    }else{
                        echo '<img src="http://localhost/clinica/'.$resultado["foto"].'" width="200px" alt="">';
